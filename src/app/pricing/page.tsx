    ...
    <div className="min-h-screen bg-[var(--paper)]">
      ...
      <main className="mx-auto max-w-[92rem] px-5 pb-20 pt-10 sm:px-8 sm:pt-14">
        ...
        <section className="mt-12 grid gap-6 rounded-3xl border border-[var(--line)] bg-white p-6 shadow-sm md:grid-cols-3 md:p-8">
          <div><h2 className="font-semibold text-[var(--ink)]">What counts as a peer review?</h2><p className="mt-2 text-sm leading-6 text-[var(--slate)]">A successful full six-reviewer analysis and final synthesis report. Provider or technical failures are released.</p></div>
